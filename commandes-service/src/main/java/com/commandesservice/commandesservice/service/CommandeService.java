package com.commandesservice.commandesservice.service;
...
import com.commandesservice.commandesservice.Repositories.CommandeRepository;
...
public class CommandeService {
    ...
    public CommandeService(CommandeRepository repo, ConfigCommande config) {
        this.repo = repo;
        this.config = config;
    }
